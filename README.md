...
## 用意するもの
- [M5Stack Atom S3](https://docs.m5stack.com/ja/core/AtomS3) - S3Liteや他のESP32S3系でも動くかも(要コード改編)
...
## 注意点
- Atom S3の底面から5Vを供給しながらPCにつなぐと危機を壊す可能性があるため、PC接続前に必ずAtomS3底面電源供給は**切断**する事
...
## 動作確認
0. [WinCE](https://brain.fandom.com/ja/wiki/Web%E3%83%96%E3%83%A9%E3%82%A6%E3%82%B6) or [Brainux](https://wiki.brainux.org/tips/usb-ethernet-gadget/)をやったBrainを用意
1. include/secret_sample.h を inculde/secret.h にコピーリネームし接続したいWi-Fiの情報を入力
2. build&デプロイする(platformio的にはuploadボタン)
3. PCとの接続を切ってからAtomS3底面に5Vを供給する
4. 画面にWLAN IP(wi-fi側のIP)が表示されたらWiFi接続完了です
5. USB Type-C - microUSBケーブルでbrainと繋ぎましょう
